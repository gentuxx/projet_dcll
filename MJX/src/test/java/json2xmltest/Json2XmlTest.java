...
/**
 * Permet d'effectuer le test de la conversion générale d'un code JSON
 */
public class Json2XmlTest {

    String xml;
    String json;
    Json2Xml converterJson2Xml;
    Xml2Json converterXml2Json;
    
	@Before
	public void setUp() throws Exception {
	    xml = "";
	    json = "";
	    converterJson2Xml = new Json2Xml();
	    converterXml2Json = new Xml2Json();
	}
	...
	public void tearDown() throws Exception {
	    xml = null;
	    json = null;
	    converterJson2Xml = null;
        converterXml2Json = null;
	}
	...
	public void testConversion() {
	    try {
            ...
            + "</category>"
            + "</question></quiz>";
            json = converterXml2Json.conversion(xml);
            json = converterJson2Xml.conversion(json);
            assertTrue(XMLComparator.compare(json, xml));   
